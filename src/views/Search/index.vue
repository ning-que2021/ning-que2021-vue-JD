      ...
      <div class="py-container">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(attrValue,index) in searchParams.props" :key="index">{{
                attrValue.split(':')[1]
                  ...
                  @click="removeattrValueName(index)">×</i></li>
          </ul>
        </div>
        ...
        <div class="details clearfix">
              ...
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click="changeOrder('1')">
                  <a>综合 <span v-show="isOne" class="iconfont"
                              :class="{'icon-up-arrow': isAsc,'icon-lvsexiangxiajiantou':isDesc}"></span></a>
                </li>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="(goods,index) in goodList" :key="goods.id">
                <div class="list-wrap">
                  <div class="p-img">
...
export default {
  ...
  methods: {
    ...
    attrInfo(attrs, attr) {
      ...
      let props = `${attrs.attrId}:${attr}:${attrs.attrName}`;
