          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:spuSale.isChecked==1}"
                    v-for="(spuSale,index) in spuSaleAttr.spuSaleAttrValueList"
                    :key="spuSale.id" @click="changeActive(spuSale,spuSaleAttr.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!--                之前的路由跳转，从A路由跳转到B路由。这里在加入购物车 进行路由跳转之前 发请求，-->
